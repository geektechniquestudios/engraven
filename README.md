...
<div align="center">
<img src="assets/heatmap.svg" width="880" alt="Animated heatmap of three knowledge bases living day to day. Phase one: a routed read heats exactly the docs a task needs, and the heat leaves a residue. Phase two: docs in two distant KBs warm and two curved links draw from them into a new synthesis doc, which is immediately indexed with a plus-one-row marker at 00-Index and persists. Phase three: an integrity scanline sweeps the vault, finds rotted cells, and flips them green.">
</div>

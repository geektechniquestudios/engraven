...
Build a three-tier KB for the subject. The full reasoning lives in Hyphasma's
KB-GUIDE (https://github.com/geektechniquestudios/hyphasma/blob/main/docs/KB-GUIDE.md);

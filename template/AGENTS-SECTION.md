<!-- ══════════════════════════════════════════════════════════════════
     HYPHASMA MEMORY PROTOCOL — appended to AGENTS.md by the Hyphasma bootstrap
...
| Encounter...                                 | Read                                                      |
| -------------------------------------------- | --------------------------------------------------------- |
| How this memory system works; where facts go | `Hyphasma-Memory-System/Hyphasma Memory System - Meta-Analysis.md` |
